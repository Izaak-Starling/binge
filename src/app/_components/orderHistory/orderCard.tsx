...
const OrderCard = (props: { order: BeanOrder }) => {
  ...
  return (
      <div
          className={"max-w-sm rounded-lg bg-origin-padding overflow-hidden shadow-lg border-binge-off-black border-2 mt-5" + (props.order.orderState === OrderState.Cancelled ? " shadow-red-700" : "")}
